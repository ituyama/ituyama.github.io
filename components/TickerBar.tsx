...
function tickerItems(quote: Quote | null): Item[] {
  ...
  if (profile.location) {
    items.push({ symbol: "LOC", name: "拠点", value: profile.location });
  }
  if (age !== null) {
    items.push({ symbol: "AGE", name: "年齢", value: `${age}歳` });
  }
  ...
  if (profile.car) {
    items.push({ symbol: "CAR", name: "愛車", value: profile.car });
  }
...
export default function TickerBar() {
  ...
  return (
    <div className="sticky top-0 z-40 h-10 overflow-hidden border-b-[1.5px] border-bento-ink bg-bento-accent text-bento-ink">
